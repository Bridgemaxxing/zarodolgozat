    ...
    <div className="absolute inset-0 bg-black/80 flex items-center justify-center z-50">
      <div className="StatDiv p-8">
        ...
        <div className="mt-6 text-center">
          <button className="Bezaras px-6 py-2" onClick={onClose}>
            {t("close")}
          </button>
        </div>
      </div>
